...
if __name__ == '__main__':
    ...
    # set up test name
    test_name = str(config['train_size']) + '_datasetsize_10classgenacc' + str(reset_per_frame) + '_seqtrain' + str(seq_train)
    print(test_name)
    ...
    with torch.no_grad():  # turn off auto grad function
        ...
        wandb.init(project="DHPC_datasetsize_genacc", entity="lucyzmf")  # , mode='disabled')
